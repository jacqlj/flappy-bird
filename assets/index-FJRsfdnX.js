(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();const Fc={get(){return this.bird.top+this.cache.birdRect.height},set(e){this.bird.top=e-this.cache.birdRect.height}};function Uc(){return`src/assets/sprites/yellowbird-${this.bird.vel<-100?"down":this.bird.vel>100?"up":"mid"}flap.png`}function Bc(){return{bottom:this.pipes[0].top+this.cache.pipePartRect.height,right:this.pipes[0].left+this.cache.pipePartRect.width}}const jc={get(){return this.pipes[0].top+this.cache.pipePartRect.height+this.cache.gapHeight/2},set(e){this.pipes[0].top=e-this.cache.pipePartRect.height-this.cache.gapHeight/2}},$c={get(){return this.pipes[1].top+this.cache.pipePartRect.height+this.cache.gapHeight/2},set(e){this.pipes[1].top=e-this.cache.pipePartRect.height-this.cache.gapHeight/2}};function qc(){return{score:String(this.state.score).split(""),best:String(this.state.best).split("")}}function zc(){return{startMenu:this.show.startMenu?"visible":"hidden",game:this.show.game?"visible":"hidden",score:this.show.game&&!this.show.gameOver?"visible":"hidden",gameOver:this.show.gameOver?"visible":"hidden"}}var ai={};/**
 * @license

(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();const Fc={get(){return this.bird.top+this.cache.birdRect.height},set(e){this.bird.top=e-this.cache.birdRect.height}};function Uc(){return{down:this.show.game&&this.bird.vel<-100?"visible":"hidden",mid:this.show.game&&this.bird.vel>100?"visible":"hidden",up:this.show.game&&this.bird.vel<=100&&this.bird.vel>=-100?"visible":"hidden"}}function Bc(){return{bottom:this.pipes[0].top+this.cache.pipePartRect.height,right:this.pipes[0].left+this.cache.pipePartRect.width}}const jc={get(){return this.pipes[0].top+this.cache.pipePartRect.height+this.cache.gapHeight/2},set(e){this.pipes[0].top=e-this.cache.pipePartRect.height-this.cache.gapHeight/2}},$c={get(){return this.pipes[1].top+this.cache.pipePartRect.height+this.cache.gapHeight/2},set(e){this.pipes[1].top=e-this.cache.pipePartRect.height-this.cache.gapHeight/2}};function qc(){return{score:String(this.state.score).split(""),best:String(this.state.best).split("")}}function zc(){return{startMenu:this.show.startMenu?"visible":"hidden",game:this.show.game?"visible":"hidden",score:this.show.game&&!this.show.gameOver?"visible":"hidden",gameOver:this.show.gameOver?"visible":"hidden"}}var as={};/**
 * @license
